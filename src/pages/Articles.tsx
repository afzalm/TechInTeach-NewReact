...
const Articles = () => {
  ...
  if (loading) {
    return (
      <PageBackground>
        <Helmet>
          <title>Articles | TechInTeach</title>
          <meta
            name="description"
            content="Read informative articles on professional development programs, modern teaching methodologies, and education trends on TechInTeach."
          />
          <link rel="canonical" href="https://techinteach.com/en/articles" />
        </Helmet>
        <Navbar />
  ...
  return (
    <>
      ...
      <PageBackground>
        ...
        {/* Mobile Menu */}
        <div className={`lg:hidden fixed inset-0 z-50 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
          {/* Overlay */}
          <div 
          ...
          {/* Sidebar Content */}
          <div className="relative w-[280px] max-w-[80%] h-full bg-white shadow-xl flex flex-col">
