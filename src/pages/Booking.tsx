...
const Booking = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Booking | TechInTeach</title>
        <meta name="description" content="Book your training session, mentoring, or consultation with TechInTeach today." />
        <link rel="canonical" href="https://techinteach.com/booking" />
      </Helmet>
